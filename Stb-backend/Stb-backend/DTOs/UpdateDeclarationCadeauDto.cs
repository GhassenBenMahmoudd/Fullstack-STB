// Dans DTOs/UpdateDeclarationCadeauDto.cs
...
namespace stb_backend.DTOs
{
    public class UpdateDeclarationCadeauDto
    {
        ...
        // Note : On n'inclut pas IdUser ici. En général, on ne permet pas de réassigner
        // une déclaration à un autre utilisateur via un simple update.
    }
}
